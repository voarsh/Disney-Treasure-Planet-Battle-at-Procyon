ScreenName String 'Confirm File Delete Dialog Screen'
...
Selectable Bool True
Enabled Bool True
ReferenceArea Rect( 444, 300, 594, 344 )	# left,top,right,bottom
Font String 'BlackChancery16'
...
Enabled Bool True
ReferenceArea Rect( 0, 239, 800, 268 )	# left,top,right,bottom
Font String 'UniversLightBold14'
Text String 'IDGS_TPFRONTENDTEXT02_FILECHANGE_DELETE'
Color Colour( 1.000000, 1.000000, 1.000000, 1.000000 )
HotKey Int -1
